...
async function gradeTyped(admin, user, question, body) {
  ...
  const system = `${pack.tutor_persona}\nYou are grading a student's written answer to an AP-style question.\nBe honest and rigorous — do not over-credit vague or incomplete answers. The student must demonstrate understanding of the underlying physics/math, not just state a correct number.\nIn the "feedback" field, do not state the final numeric or conclusive answer outright (e.g. never write something like "the answer is k = 6") — this applies even to a zero-credit, blank, or placeholder submission. Describe what step or concept is missing instead, the way a tutor would guide a student rather than hand them the solution. Put any full explanation of what a correct answer looks like in "correct_elements"/"missing_elements", not spelled out in "feedback".\n${pack.frq_rubric.general_guidance}\nReturn JSON only, no other text.`
