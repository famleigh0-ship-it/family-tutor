...
export default function TextLogInput({ packId, onResult }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <label htmlFor="classroom-description" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
      ...
      <textarea
        ...
        className="w-full rounded-lg border border-slate-300 p-3 text-base focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:focus:border-slate-400 dark:focus:ring-slate-400"
      />
